...
### 저장구조
int i = 1;
0000000 | 0000000 | 00000000 | 00000001 (실제 메모리에 저장되는 i의 형태)
...
short는 4byte크기이므로 16bit이다. 그렇다면 총 2의 16승 가지수 만큼 수를 표현할수있는가? 
아니다. 맨앞의 한비트는 부호를 표현해야 하므로 사용가능한 비트수는 15개가 되며 또한 0을 포함해야 한다. 
